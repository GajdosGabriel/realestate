...
return [
    ...
    'title' => 'How to earn 25% ROI per year in dividend',
    ...
    '60' => 'ŠÍRAVA PARK:',
    '61' => 'BOULEVARD is a public beach, marina and green area with a wide range of activities.',
    '6b' => 'GLAMPING is where stunning nature meets modern luxury, without having to sacrifice our comforts.',
    '6c' => 'APARTMENTS on walking distance to the Boulevard with spectacular view of lake Zemplínska Šírava.',
    '1' => '182 Apartments',
    ...
    'text6' => 'We offer 2 options how to invest in Šírava Park phase 1 with CEE Real Estate Group:',
    'pr' => 'Pooled resources:',
    ...
    'after_video1' => 'CEE Real Estate Group continues to set a new standard for balanced and sustainable living. There are great opportunities for investors from the start. The land is located in the cadastral area of Klokočov, in an attractive recreation area Zemplínska Šírava, Slovakia, about 50 meters from the water with a wide possibility of its use.',
    'future' => 'Glamping and Apartments',
    'future_text' => 'In base of CEE preliminary real estate research in location of Šírava it is our plan in this stage to buy and prepare the land for basic infrastructure and divide the land in multiple plots. CEE real estate group will pre-sell and build the properties on this multiple plots phase by phase.',
