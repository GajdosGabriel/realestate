...
@section('title', env('APP_NAME') . ' :: Agent area - User edit')

@section('content')
    <div class="container xs-pt-20 xs-pb-50">
        <div class="card">
            <div class="card-body">
                <a href="{{ route('agent.users.user', ['id' => $objUser->id]) }}"><- Back to user details</a>

                <h3 class="xs-mt-20">Edit User</h3>

                <form action="{{ route('agent.users.userEditPost') }}" id="userEditForm" method="POST" class="cee">
