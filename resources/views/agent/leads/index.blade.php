...
@section('title', env('APP_NAME') . ' :: Agent area - Leads')
    ...
    <div class="container-fluid xs-pt-20">
        <div class="card">
            <div class="card-body">
                <div id="adminPanel">
                    <div class="item">
                        <h3>All leads <span class="badge badge-secondary">{{ count($arrLeads) }} / {{ $arrLeads->total() }}</span></h3>
                    </div>
            ...
            <div class="card-body">
                <ul class="list-group users">
                    @foreach($arrLeads as $objLead)
                        @component('components/agent/lead', ['objLead' => $objLead])@endcomponent
                    @endforeach
                </ul>
            </div>
        </div>
