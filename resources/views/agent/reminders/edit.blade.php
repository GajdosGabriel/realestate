...
@section('title', env('APP_NAME') . ' :: Agent area - Reminder edit')
...
@section('content')
    <div class="container xs-pt-20 xs-pb-50">
        <div class="card">
            <div class="card-body">
                <a href="{{ route('agent.users.user', ['id' => $objReminder->user_id]) }}"><- Back to user details</a>

                <h3 class="xs-mt-20">Edit reminder</h3>

                <form action="{{ route('agent.reminders.editPost') }}" id="reminderEditForm" method="POST" class="cee">
