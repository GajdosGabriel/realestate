...
@section('title', env('APP_NAME') . ' :: Admin area - Articles')
            ...
            <div class="card-body">
                <div id="adminPanel">
                    ...
                    <div class="float-right">
                        <div class="item">
                            <a href="{{ route('admin.articles.new') }}" class="btn btn-sm btn-secondary">New article</a>
                        </div>
            ...
            <div class="card-body">
                <ul class="list-group users xs-mb-20">
                    @foreach($arrArticles as $objArticle)
                        @component('components/admin/article', ['objArticle' => $objArticle])@endcomponent
                    @endforeach
                </ul>
