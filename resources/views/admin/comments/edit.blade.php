...
@section('title', env('APP_NAME') . ' :: Admin area - Comment edit')

@section('content')
    <div class="container xs-pt-20 xs-pb-50">
        <div class="card">
            <div class="card-body">
                <a href="{{ route('admin.users.user', ['id' => $objComment->user->id]) }}"><- Back to user details</a>

                <h3 class="xs-mt-20">Edit comment</h3>

                <form action="{{ route('admin.comments.editPost') }}" id="commentEditForm" method="POST" class="cee">
