...
@section('title', env('APP_NAME') . ' :: Admin area - Orders')
    ...
    <div class="container-fluid xs-pt-20">
        <div class="card">
            <div class="card-body">
                <div id="adminPanel">
                    <div class="item">
                        <h3>All orders <span class="badge badge-secondary">{{ count($arrOrders) }} / {{ $arrOrders->total() }}</span></h3>
                    </div>
            ...
            <div class="card-body">
                <ul class="list-group users">
                    @foreach($arrOrders as $objOrder)
                        @component('components/admin/orderPayment', ['objOrder' => $objOrder])@endcomponent
                    @endforeach
                </ul>
            </div>
        </div>
