            ...
            <div class="col-12 col-lg-9">
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group users">
                                    @foreach($arrNewest as $objUser)
                                        @component('components/admin/newestUser', ['objUser' => $objUser])@endcomponent
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-6 xs-mt-30">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="xs-mb-20">Newest partners <span class="badge badge-secondary">{{ count($arrPartners) }}</span></h3>
                    ...
                    <div class="col-12 col-lg-6 xs-mt-30">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="xs-mb-20">Newest Orders <span class="badge badge-secondary">{{ count($arrOrders) }}</span></h3>
