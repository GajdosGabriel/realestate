        ...
        <nav id="publicNavbar" class="navbar navbar-expand-lg navbar-light bg-light generalNavbar">
            ...
            <div class="collapse navbar-collapse" id="publicNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link active" href="{{ route('public.home') }}">@lang('nav.home')</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu lang" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ route('public.lang', ['lang' => 'de']) }}">Deutsch</a>

                            <a class="dropdown-item" href="{{ route('public.lang', ['lang' => 'en']) }}">English</a>
                        </div>
                    </li>
                </ul>
            </div>
