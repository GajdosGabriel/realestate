<li class="list-group-item {{ $objActivity->user->statusClass }}">
    <span class="float-right">
        @if($objActivity->user->referral != null)<a href="{{ route('agent.users.user', ['id' => $objActivity->user->referral->id]) }}" class="badge badge-dark" data-toggle="tooltip" data-placement="top" title="Referral">{{ $objActivity->user->referral->name }} {{ $objActivity->user->referral->surname }}</a> |@endif
    ...
    <a href="{{ route('agent.users.user', ['id' => $objActivity->user->id]) }}" class="font-weight-bold">{{ $objActivity->user->name }} {{ $objActivity->user->surname }}</a>
