...
<p>{{ config('cee.director') }}, CEE Real Estate Group s.r.o., Gorkého 5, 81101, Bratislava, Slovak Republic, @lang('member/contracts/tdo_poa.next2', [], 'sk')</p>
...
@if(App::getLocale() != 'sk')
    ...
    <p class="lang">{{ config('cee.director') }}, CEE Real Estate Group s.r.o., Gorkého 5, 81101, Bratislava, Slovak Republic, @lang('member/contracts/tdo_poa.next2')</p>
@endif

<p>
    @lang('member/contracts/tdo_poa2.1', [], 'sk')
    {{ $objOrder->tdo->shares }}
    @lang('member/contracts/tdo_poa2.2', [], 'sk')
    &euro; {{ number_format($objOrder->tdo->investment, 0, ',', ' ') }}.
</p>

<p>@lang('member/contracts/tdo_poa2.3', [], 'sk')</p>

@if(App::getLocale() != 'sk')
    <p class="lang">
        @lang('member/contracts/tdo_poa2.1')
        {{ $objOrder->tdo->shares }}
        @lang('member/contracts/tdo_poa2.2')
        &euro; {{ number_format($objOrder->tdo->investment, 0, ',', ' ') }}.
    </p>

    <p class="lang">@lang('member/contracts/tdo_poa2.3')</p>
@endif
