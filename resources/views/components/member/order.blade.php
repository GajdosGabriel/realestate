...
{{--        @lang('member/invest/order.investment') &euro; {{ number_format($objOrder->sp->project->total_investment, 0, '', ' ') }} | --}}
        @lang('member/invest/order.yourInvestment') <strong>&euro; {{ number_format($objOrder->sp->investment, 0, '', ' ') }}</strong>
    @elseif($objOrder->pr)
