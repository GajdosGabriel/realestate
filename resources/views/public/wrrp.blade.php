...
@section('projectContent')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div>
                <a href="{{ asset('images/member/hot/wrrp/1.jpg') }}" data-lightbox="photos" target="_blank"><img
            ...
            <div class="row xs-mt-20">
                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/2.jpg') }}" data-lightbox="photos" target="_blank"><img
                                src="{{ asset('images/member/hot/wrrp/2.jpg') }}"
                                class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/3.jpg') }}" data-lightbox="photos" target="_blank"><img
                                src="{{ asset('images/member/hot/wrrp/3.jpg') }}"
                                class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/4.jpg') }}" data-lightbox="photos" target="_blank"><img
            ...
            <div class="row xs-mt-20">
                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/5.jpg') }}" data-lightbox="photos" target="_blank"><img
                                src="{{ asset('images/member/hot/wrrp/5.jpg') }}"
                                class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/6.jpg') }}" data-lightbox="photos" target="_blank"><img
                                src="{{ asset('images/member/hot/wrrp/6.jpg') }}"
                                class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/7.jpg') }}" data-lightbox="photos" target="_blank"><img
            ...
            <div class="row xs-mt-20">
                <div class="col-12">
                    <a href="{{ asset('images/member/hot/wrrp/8.jpg') }}" data-lightbox="photos" target="_blank"><img
            ...
            <div class="row xs-mt-20">
                <div class="col-6">
                    <a href="{{ asset('images/member/hot/wrrp/9.jpg') }}" data-lightbox="photos" target="_blank"><img
                                src="{{ asset('images/member/hot/wrrp/9.jpg') }}"
                                class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-6">
                    <a href="{{ asset('images/member/hot/wrrp/10.jpg') }}" data-lightbox="photos" target="_blank"><img
            ...
            <div class="row xs-mt-20">
                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/11.jpg') }}" data-lightbox="photos" target="_blank"><img
                ...
                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/12.jpg') }}" data-lightbox="photos" target="_blank"><img
                                src="{{ asset('images/member/hot/wrrp/12.jpg') }}"
                                class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/13.jpg') }}" data-lightbox="photos" target="_blank"><img
            ...
            <div class="row xs-mt-20">
                <div class="col-6">
                    <a href="{{ asset('images/member/hot/wrrp/14.jpg') }}" data-lightbox="photos" target="_blank"><img
                                src="{{ asset('images/member/hot/wrrp/14.jpg') }}"
                                class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-6">
                    <a href="{{ asset('images/member/hot/wrrp/15.jpg') }}" data-lightbox="photos" target="_blank"><img
            ...
            <div class="row xs-mt-20">
                <div class="col-6">
                    <a href="{{ asset('images/member/hot/wrrp/16.jpg') }}" data-lightbox="photos" target="_blank"><img
                                src="{{ asset('images/member/hot/wrrp/16.jpg') }}"
                                class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-6">
                    <a href="{{ asset('images/member/hot/wrrp/17.jpg') }}" data-lightbox="photos" target="_blank"><img
            ...
            <div class="row xs-mt-20">
                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/18.jpg') }}" data-lightbox="photos" target="_blank"><img
                                src="{{ asset('images/member/hot/wrrp/18.jpg') }}"
                                class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/19.jpg') }}" data-lightbox="photos" target="_blank"><img
                                src="{{ asset('images/member/hot/wrrp/19.jpg') }}"
                                class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/20.jpg') }}" data-lightbox="photos" target="_blank"><img
            ...
            <div class="row xs-mt-20">
                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/21.jpg') }}" data-lightbox="photos" target="_blank"><img
                                src="{{ asset('images/member/hot/wrrp/21.jpg') }}"
                                class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/22.jpg') }}" data-lightbox="photos" target="_blank"><img
                                src="{{ asset('images/member/hot/wrrp/22.jpg') }}"
                                class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/hot/wrrp/23.jpg') }}" data-lightbox="photos" target="_blank"><img
...
@section('projectDetails')
    <div class="info bg_grey">
        ...
        <p>Cost of buying <span class="float-right">&euro; 600 000</span></p>

        <p>Book value <span class="float-right">&euro; 3 600 000</span></p>

        <p>Technology value <span class="float-right">&euro; 500 000</span></p>

        <p>Renovation / Rebuild <span class="float-right">&euro; 1-2M</span></p>

        <p>Expected ROI by completion <span class="float-right">45-65%</span></p>

        <p class="xs-mb-0">Area <span class="float-right">24 704 m<sup>2</sup></span></p>
    </div>
