...
@section('projectName')
    Office building Dunajská 4
@endsection

@section('projectHeader')
    <img src="{{ asset('images/member/project/cover.jpg') }}" class="img-fluid mx-auto" alt="">
...
@section('projectContent')
            ...
            <div class="media">
                ...
                <div class="media-body">
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            <ul>
                                <li>Very attractive location in vicinity of old town of capital city of Slovakia</li>

                                <li>Zone of high potential with future big renovations of square Kamenne Namestie which will add value to this buildings</li>

                                <li>Two older building not meeting today`s office standards</li>

                                <li>Land in backyard with potential of new residential development to complete the street line of neighbouring historical buildings on Grosslingova street</li>

                                <li>Possible weakness: not sufficient parking capacities for permanent residential</li>

                                <li>Best solution: build new modern Office / Apartment for temporary stay or even chain network Hotel</li>
                            </ul>
                        </div>

                        <div class="col-12 col-lg-4">
                            <a href="{{ asset('images/member/project/12.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/project/12.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card-body">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <a href="{{ asset('images/member/project/1.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/project/1.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <a href="{{ asset('images/member/project/10.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/project/10.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                        </div>

                        <div class="col-12 col-lg-6">
                            <a href="{{ asset('images/member/project/11.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/project/11.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                        </div>
                    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <a href="{{ asset('images/member/project/4.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/project/4.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-12 col-lg-6">
                    <a href="{{ asset('images/member/project/5.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/project/5.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <a href="{{ asset('images/member/project/8.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/project/8.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
            ...
            <a href="{{ asset('images/member/project/9.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/project/9.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div>
                <a href="{{ asset('images/member/project/6.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/project/6.jpg') }}" class="img-fluid mx-auto" alt=""></a>
            </div>

            <div class="row xs-mt-20">
                <div class="col-4">
                    <a href="{{ asset('images/member/project/2.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/project/2.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/project/7.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/project/7.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-4">
                    <a href="{{ asset('images/member/project/3.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/project/3.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>
            </div>
        </div>
    </div>
...
@section('projectDetails')
    <div class="info bg_grey">
        ...
        <p>Cost of buying <span class="float-right">&euro; 9 300 000</span></p>

        <p>Current ROI (Existing tenants) <span class="float-right">5% p.a.</span></p>
