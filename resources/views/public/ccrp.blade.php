...
@section('projectContent')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <a href="{{ asset('images/member/hot/ccrp/1.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/1.jpg') }}" class="img-fluid mx-auto w-100" alt=""></a>

            <div class="row xs-mt-20 xs-mb-20">
                <div class="col-12 col-lg-3 xs-pb-20">
                    <a href="{{ asset('images/member/hot/ccrp/2.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/sm/2.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-12 col-lg-3 xs-pb-20">
                    <a href="{{ asset('images/member/hot/ccrp/3.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/sm/3.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-12 col-lg-3 xs-pb-20">
                    <a href="{{ asset('images/member/hot/ccrp/4.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/sm/4.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-12 col-lg-3">
                    <a href="{{ asset('images/member/hot/ccrp/5.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/sm/5.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>
            </div>
            ...
            <a href="{{ asset('images/member/hot/ccrp/6.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/sm/6.jpg') }}" class="img-fluid w-100" alt=""></a>

            <div class="row xs-mt-20">
                <div class="col-12 col-lg-4 xs-pb-20">
                    <a href="{{ asset('images/member/hot/ccrp/7.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/sm/7.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-12 col-lg-4 xs-pb-20">
                    <a href="{{ asset('images/member/hot/ccrp/8.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/sm/8.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-12 col-lg-4">
                    <a href="{{ asset('images/member/hot/ccrp/9.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/sm/9.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>
            </div>

            <div class="row xs-mt-20 xs-mb-20">
                <div class="col-12 col-lg-4 xs-pb-20">
                    <a href="{{ asset('images/member/hot/ccrp/10.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/sm/10.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-12 col-lg-4 xs-pb-20">
                    <a href="{{ asset('images/member/hot/ccrp/11.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/sm/11.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-12 col-lg-4">
                    <a href="{{ asset('images/member/hot/ccrp/12.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/sm/12.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>
            </div>
            ...
            <div>
                <a href="{{ asset('images/member/hot/ccrp/plans/0.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/plans/sm/0.jpg') }}" class="img-fluid mx-auto" alt=""></a>
            </div>

            <div class="row xs-mt-20">
                <div class="col-3">
                    <a href="{{ asset('images/member/hot/ccrp/plans/1.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/plans/sm/1.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-3">
                    <a href="{{ asset('images/member/hot/ccrp/plans/2.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/plans/sm/2.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-3">
                    <a href="{{ asset('images/member/hot/ccrp/plans/3.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/plans/sm/3.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>

                <div class="col-3">
                    <a href="{{ asset('images/member/hot/ccrp/plans/4.jpg') }}" data-lightbox="photos" target="_blank"><img src="{{ asset('images/member/hot/ccrp/plans/sm/4.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                </div>
            </div>
        </div>
    </div>
...
@section('projectDetails')
    <div class="info bg_grey">
        ...
        <p class="xs-mb-0">Expected ROI <span class="float-right">35%</span></p>
    </div>

    <a href="{{ asset('documents/ccrp.pdf') }}" class="btn btn-block btn-primary" target="_blank">Value calculation</a>
@endsection