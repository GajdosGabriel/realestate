<div id="contactBlock" class="container pageBlock">
    ...
    <div class="row">
        <div class="col-12 col-lg-4">
            ...
            <address>
                ...
                <span class="color_primary">@lang('public/contact.company'):</span> 51 773 074<br>
    ...
    <div class="text-center xs-mt-20 lg-mt-50 xs-mb-20">
