...
@section('title', env('APP_NAME') . ' :: Marketing area - Articles - Edit article')
    ...
    <div class="container xs-pt-20 xs-pb-50">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('marketing.articles.articleEditPost') }}" id="articleEditForm" method="POST" class="cee">
