...
@section('title', env('APP_NAME') . ' :: Marketing area - Article - ' . $objArticle->title)
            ...
            <div class="card-body">
                <div id="adminPanel">
                    ...
                    <div class="float-right">
                        <div class="item">
                            <a href="{{ route('marketing.articles.articleEdit', ['id' => $objArticle->id]) }}" class="btn btn-sm btn-secondary">Edit</a>
                        </div>
