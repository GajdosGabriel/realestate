...
@section('title', env('APP_NAME') . ' :: Member area - Land investments -Zemplínska Šírava - Split in plots')

@section('startBody')
    @component('components/member/projectContactModal', ['title' => 'Land investments / Zemplínska Šírava Split in plots'])
    @endcomponent
@endsection

@section('content')
    <div class="container-fluid project-header">
        <img src="{{ asset('images/member/land/sirava/cover.jpg') }}" class="img-fluid mx-auto" alt="">

        <div class="name">
            <div class="container">
                <h1>Zemplínska Šírava <small>Split in plots</small></h1>
                        ...
                        <div class="card-body">
                            ...
                            <div class="media xs-mt-20">
                                ...
                                <div class="media-body">
                                    <p>Zemplínska Šírava is the second largest body of water in Slovak Republic (33.5 km2) and is the twelfth largest lake in Europe. It is known for the largest number of sunny and tropical days within the year.
                                        It is located in the immediate vicinity of Michalovce district (40 k inhabitants) and 50km from the second largest city in Slovakia - Košice (250 k inhabitants) with the Kosice international airport.</p>
                                </div>
                            </div>
                            ...
                            <div class="media xs-mb-20 lg-mb-30">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>The purchase of the land, the application for distribution in the cadaster for 300 parcels and building the basic infrastructure to the parcels and subsequent individual land sales.</p>
                                </div>
                            </div>
                            ...
                            <div class="media xs-mb-20 lg-mb-30">
                                ...
                                <div class="media-body">
                                    ...
                                    <ul>
                                        <li>The city of Kosice with the International Airport (55km)</li>
