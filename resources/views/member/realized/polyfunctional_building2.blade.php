...
@section('title', env('APP_NAME') . ' :: Member area - Realized projects - Polyfunctional building 2')

@section('startBody')
    @component('components/member/projectContactModal', ['title' => 'Realized projects / Polyfunctional building 2'])
    @endcomponent
@endsection
...
@section('content')
    <div class="container-fluid project-header">
        ...
        <img src="{{ asset('images/member/realized/polyfunctional_building2/cover.jpg') }}" alt="">

        <div class="name">
            <div class="container">
                <h1>Polyfunctional building 2 - 25% ROI</h1>
                ...
                <div class="col-12 col-lg-8 project-details">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ asset('images/member/realized/polyfunctional_building2/1.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/polyfunctional_building2/1.jpg') }}" class="img-fluid d-block w-100 xs-mb-20" alt=""></a>

                            <div class="row xs-mt-20">
                                <div class="col-4">
                                    <a href="{{ asset('images/member/realized/polyfunctional_building2/2.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/polyfunctional_building2/2.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/realized/polyfunctional_building2/3.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/polyfunctional_building2/3.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/realized/polyfunctional_building2/4.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/polyfunctional_building2/4.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
