...
@section('title', env('APP_NAME') . ' :: Member area - Realized projects - project 1')

@section('startBody')
    @component('components/member/projectContactModal', ['title' => 'Realized projects / project 1'])
    @endcomponent
@endsection
...
@section('content')
    <div class="container-fluid project-header">
        ...
        <img src="{{ asset('images/member/realized/project1/cover.jpg') }}" alt="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row xs-mt-20">
                                <div class="col-4">
                                    <a href="{{ asset('images/member/realized/project1/1.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/project1/sm/1.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/realized/project1/2.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/project1/sm/2.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/realized/project1/3.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/project1/sm/3.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
