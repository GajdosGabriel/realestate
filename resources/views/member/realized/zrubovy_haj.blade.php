...
@section('title', env('APP_NAME') . ' :: Member area - Realized projects - Zrubový háj')

@section('startBody')
    @component('components/member/projectContactModal', ['title' => 'Realized projects / Zrubový háj'])
    @endcomponent
@endsection
...
@section('content')
    <div class="container-fluid project-header">
        ...
        <img src="{{ asset('images/member/realized/zrubovy_haj/cover.jpg') }}" alt="">

        <div class="name">
            <div class="container">
                <h1>Zrubový háj - 35% ROI</h1>
                ...
                <div class="col-12 col-lg-8 project-details">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ asset('images/member/realized/zrubovy_haj/1.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/zrubovy_haj/1.jpg') }}" class="img-fluid d-block w-100 xs-mb-20" alt=""></a>

                            <div class="row xs-mt-20">
                                <div class="col-4">
                                    <a href="{{ asset('images/member/realized/zrubovy_haj/2.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/zrubovy_haj/2.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/realized/zrubovy_haj/3.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/zrubovy_haj/3.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/realized/zrubovy_haj/4.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/zrubovy_haj/4.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
