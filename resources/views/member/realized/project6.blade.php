...
@section('title', env('APP_NAME') . ' :: Member area - Realized projects - project 6')

@section('startBody')
    @component('components/member/projectContactModal', ['title' => 'Realized projects / project 6'])
    @endcomponent
@endsection
...
@section('content')
    <div class="container-fluid project-header">
        ...
        <img src="{{ asset('images/member/realized/project6/cover.jpg') }}" alt="">

        <div class="name">
            <div class="container">
                <h1>Project 6<small></small></h1>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title">Photos</h2>
													...
													<a href="{{ asset('images/member/realized/project6/3.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/project6/3.jpg') }}" class="img-fluid d-block mx-auto xs-mb-20" alt=""></a>

                            <div class="row xs-mt-20">
                                <div class="col-6">
                                    <a href="{{ asset('images/member/realized/project6/1.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/project6/1.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-6">
                                    <a href="{{ asset('images/member/realized/project6/2.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/project6/2.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>
