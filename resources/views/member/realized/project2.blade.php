...
@section('title', env('APP_NAME') . ' :: Member area - Realized projects - project 2')

@section('startBody')
    @component('components/member/projectContactModal', ['title' => 'Realized projects / project 2'])
    @endcomponent
@endsection
...
@section('content')
    <div class="container-fluid project-header">
        ...
        <img src="{{ asset('images/member/realized/project2/cover.jpg') }}" alt="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title">Photos</h2>
														...
														<a href="{{ asset('images/member/realized/project2/3.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/project2/3.jpg') }}" class="img-fluid d-block mx-auto xs-mb-20" alt=""></a>

                            <div class="row xs-mt-20">
                                <div class="col-6">
                                    <a href="{{ asset('images/member/realized/project2/1.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/project2/1.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-6">
                                    <a href="{{ asset('images/member/realized/project2/2.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/project2/2.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>
