...
@section('title', env('APP_NAME') . ' :: Member area - Realized projects - Low budget bungalow')

@section('startBody')
    @component('components/member/projectContactModal', ['title' => 'Realized projects / Low budget bungalow'])
    @endcomponent
@endsection
...
@section('content')
    <div class="container-fluid project-header">
        ...
        <img src="{{ asset('images/member/realized/low-budget-bungalow/cover.jpg') }}" alt="">

        <div class="name">
            <div class="container">
                <h1>Low budget bungalow - 30% ROI</h1>
                ...
                <div class="col-12 col-lg-8 project-details">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ asset('images/member/realized/low-budget-bungalow/low-budget-bungalow-3.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/low-budget-bungalow/low-budget-bungalow-3.jpg') }}" class="img-fluid d-block mx-auto xs-mb-20" alt=""></a>

                            <div class="row xs-mt-20">
                                <div class="col-6">
                                    <a href="{{ asset('images/member/realized/low-budget-bungalow/low-budget-bungalow-1.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/low-budget-bungalow/low-budget-bungalow-1.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-6">
                                    <a href="{{ asset('images/member/realized/low-budget-bungalow/low-budget-bungalow-2.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/low-budget-bungalow/low-budget-bungalow-2.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
