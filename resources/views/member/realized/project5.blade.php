...
@section('title', env('APP_NAME') . ' :: Member area - Realized projects - project 5')

@section('startBody')
    @component('components/member/projectContactModal', ['title' => 'Realized projects / project 5'])
    @endcomponent
@endsection
...
@section('content')
    <div class="container-fluid project-header">
        ...
        <img src="{{ asset('images/member/realized/project5/cover.jpg') }}" alt="">

        <div class="name">
            <div class="container">
                <h1>Project 5 <small></small></h1>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title">Photos</h2>
													...
													<a href="{{ asset('images/member/realized/project5/2.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/project5/2.jpg') }}" class="img-fluid d-block mx-auto xs-mb-20" alt=""></a>
													
                            <div class="row xs-mt-20">
                                <div class="col-6">
                                    <a href="{{ asset('images/member/realized/project5/1.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/realized/project5/1.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>
