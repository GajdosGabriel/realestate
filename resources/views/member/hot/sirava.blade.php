...
@section('title', env('APP_NAME') . ' :: Member area - Hot projects - Zemplínska Šírava')

@section('startBody')
    @component('components/member/projectContactModal', ['title' => 'Hot projects / Zemplínska Šírava'])
    @endcomponent
@endsection

@section('content')
    <div class="container-fluid project-header">
        <img src="{{ asset('images/member/hot/sirava/cover.jpg') }}" class="img-fluid mx-auto" alt="">

        <div class="name">
            <div class="container">
                <h1>Zemplínska Šírava</h1>

                <p class="lead">Zemplínska Šírava, Slovak Republic</p>
							
                <h2>Expected <strong>ROI</strong>  by completion <strong>35-55% </strong></h2>
            </div>
        </div>
    </div>
                ...
                <div class="col-12 col-lg-8 project-details">
                        ...
                        <div class="card-body">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Purchase of the land, apply for building a replica of CEE project in the High Tatras (<a href="https://www.cee-realestate.com/member/realized-projects/ceresnovy-sad" target="_blank">https://www.cee-realestate.com/member/realized-projects/ceresnovy-sad</a>) ad hotel and restaurant to it.</p>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-4">
                                    <a href="{{ asset('images/member/hot/sirava/1.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/hot/sirava/sm/1.jpg') }}" class="img-fluid d-block mx-auto xs-mb-20" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/hot/sirava/2.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/hot/sirava/sm/2.jpg') }}" class="img-fluid d-block mx-auto xs-mb-20" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/hot/sirava/3.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/hot/sirava/sm/3.jpg') }}" class="img-fluid d-block mx-auto xs-mb-20" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/hot/sirava/4.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/hot/sirava/sm/4.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/hot/sirava/5.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/hot/sirava/sm/5.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/hot/sirava/6.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/hot/sirava/sm/6.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <a href="{{ asset('images/member/hot/sirava/sirava_area.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/hot/sirava/sirava_area.jpg') }}" class="img-fluid mx-auto" alt=""></a>
                            </div>

                            <div class="row xs-mt-20">
                                <div class="col-4">
                                    <a href="{{ asset('images/member/hot/sirava/7.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/hot/sirava/sm/7.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/hot/sirava/8.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/hot/sirava/sm/8.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>

                                <div class="col-4">
                                    <a href="{{ asset('images/member/hot/sirava/9.jpg') }}" data-lightbox="photos"><img src="{{ asset('images/member/hot/sirava/sm/9.jpg') }}" class="img-fluid d-block mx-auto" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-4 project-information">
                    <div class="stickyBlock">
                        <div class="info bg_grey">
                            ...
                            <p>Expected ROI by completion <span class="float-right">35-55%</span></p>
