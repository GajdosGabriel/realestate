...
@section('title', env('APP_NAME') . ' :: Member area - Managed real estate projects')

@section('startBody')
    @component('components/member/projectContactModal', ['title' => 'Managed real estate projects'])
    @endcomponent
@endsection
...
@section('content')
    <div class="container-fluid project-header">
        ...
        <div class="name">
            <div class="container">
                <h1>Managed real estate projects</h1>
                        ...
                        <div class="card-body">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    @include('includes/videos/product_long')
                                </div>
                            </div>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h3>Possible options of properties, land or new developments projects</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>New construction is generally expected to create a variety of real estate investing opportunities. For example, in cities with new construction, house prices tend to increase as well as the demand for new improved houses. For real estate investors, this is definitely a money-gaining opportunity. When it comes to investing in residential real estate, there are only two basic types of property you can invest in – new construction and resale.</p>
                                </div>
                            </div>
                        </div>
                    </div>
