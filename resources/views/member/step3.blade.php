...
@section('content')
    <div class="container xs-mt-20 xs-mb-20 lg-mt-50 lg-mb-50">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="media align-items-center xs-mt-20">
                                ...
                                <div class="media-body">
                                    <h2 id="bankTransferHeader" class="color_primary font-pt-serif xs-mb-0">@lang('member/invest/step3.bank')</h2>
                                </div>
                            </div>
                        </div>
        ...
        {{-- PR finish--}}
        @if(($objOrder->pr and $objBankDetails))
            <div class="card bg_secondary">
                <div class="card-body">
                    <form action="{{ route('member.step3Post') }}" method="POST" class="cee">
                        @csrf
