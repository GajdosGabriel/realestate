...
class Step1Request extends FormRequest {
    ...
    public function rules() {
        return [
            ...
            // Silent Partner
            'sp.project' => 'required_if:type,sp|integer|exists:projects,id',
            'sp.shares' => 'required_if:type,sp|numeric|min:0.025|max:3',

            // Pooled resources
            'pr.number' => 'required_if:type,pr|integer|min:1',
            'pr.duration' => ['required_if:type,pr', 'integer', Rule::in([2, 3, 4])],
