...
(lib.Tween8 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-305.5,-142.8,0.6627,0.6627);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-305.5,-142.8,611,285.6);
...
(lib.Tween6 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-305,-128.65,0.6616,0.6616);
...
(lib.Tween5 = function(mode,startPosition,loop) {
	...
	this.instance = new lib._03();
	this.instance.parent = this;
	this.instance.setTransform(-305,-128.7,0.6616,0.6616);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-305,-128.7,610,257.4);
...
(lib.Scene_1_text2 = function(mode,startPosition,loop) {
	...
	// text2
	this.text = new cjs.Text("IN 24 MONTHS FROM", "bold 25px 'Arial'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 30;
	this.text.lineWidth = 262;
	this.text.parent = this;
	this.text.setTransform(291.9,96.55);
	this.text.shadow = new cjs.Shadow("rgba(0,0,0,1)",1,1,4);
	this.text._off = true;

	this.timeline.addTween(cjs.Tween.get(this.text).wait(96).to({_off:false},0).to({y:52.55},24).to({_off:true},83).wait(111).to({_off:false},0).wait(96));
...
(lib.Scene_1_text1 = function(mode,startPosition,loop) {
	...
	// text1
	this.text = new cjs.Text("INVEST IN ŠÍRAVA PARK, 20% ROI", "bold 25px 'Arial'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 30;
	this.text.lineWidth = 419;
	this.text.parent = this;
	this.text.setTransform(370.4,-35.65);
	this.text.shadow = new cjs.Shadow("rgba(0,0,0,1)",1,1,4);
	this.text._off = true;

	this.timeline.addTween(cjs.Tween.get(this.text).wait(72).to({_off:false},0).to({y:16.35},24).to({_off:true},107).wait(111).to({_off:false},0).wait(96));
...
(lib.Scene_1__000 = function(mode,startPosition,loop) {
	...
	this.text.parent = this;
	this.text.setTransform(503.65,43.35);
...
(lib.Scene_1_pic2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(429.5,-48.2);
	this.instance._off = true;

	this.instance_1 = new lib.Tween8("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(429.5,113.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},203).to({state:[{t:this.instance_1}]},111).wait(96));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(203).to({_off:false},0).to({_off:true,y:113.8},111).wait(96));
...
(lib.Scene_1_pic1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(429,-34.3);

	this.instance_1 = new lib.Tween6("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(429,128.65);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},165).wait(39));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,y:128.65},165).wait(39));
...
// stage content:
(lib._728x90_ecopark0123_EN = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.pic1.setTransform(429,-34.4,1,1,0,0,0,429,-34.4);
	this.pic1.depth = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.pic1).wait(165).to({_off:true},39).wait(206));
...
p.nominalBounds = new cjs.Rectangle(364.2,-146,370.8,403.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"_02.jpg?1548321759611", id:"_02"},
		{src:"_03.jpg?1548321759611", id:"_03"},
		{src:"Logo_CEE_GoldWhite.png?1548321759611", id:"Logo_CEE_GoldWhite"}
	],
	preloads: []
};
