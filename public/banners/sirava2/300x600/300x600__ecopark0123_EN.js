...
(lib.Tween9 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-402,-187.9,0.872,0.872);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-402,-187.9,804,375.9);
...
(lib.Tween7 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-445,-187.75,0.9653,0.9653);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-445,-187.7,890,375.5);
...
(lib.Symbol_1_Layer_1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.text = new cjs.Text("MORE INFO", "bold 23px 'Arial'");
...
(lib.Scene_1_text2 = function(mode,startPosition,loop) {
	...
	// text2
	this.text = new cjs.Text("20% ROI IN 24 MONTHS", "bold 23px 'Arial'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 32;
	this.text.lineWidth = 262;
	this.text.parent = this;
	this.text.setTransform(459.1,213.25);
	this.text.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,4);
	this.text._off = true;

	this.timeline.addTween(cjs.Tween.get(this.text).wait(102).to({_off:false},0).to({x:150},21).to({_off:true},117).wait(76).to({_off:false},0).wait(69));
...
(lib.Scene_1_text1 = function(mode,startPosition,loop) {
	...
	// text1
	this.text = new cjs.Text("INVEST IN ŠÍRAVA PARK", "bold 23px 'Arial'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 32;
	this.text.lineWidth = 282;
	this.text.parent = this;
	this.text.setTransform(457.1,155.85);
	this.text.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,4);
	this.text._off = true;

	this.timeline.addTween(cjs.Tween.get(this.text).wait(81).to({_off:false},0).to({x:151},21).to({_off:true},138).wait(76).to({_off:false},0).wait(69));
...
(lib.Scene_1_from = function(mode,startPosition,loop) {
	...
	// from
	this.text = new cjs.Text("FROM", "bold 23px 'Arial'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 32;
	this.text.lineWidth = 76;
	this.text.parent = this;
	this.text.setTransform(-51,278.25);
	this.text.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,4);
	this.text._off = true;

	this.timeline.addTween(cjs.Tween.get(this.text).wait(123).to({_off:false},0).to({x:66.05},11).to({_off:true},106).wait(76).to({_off:false},0).wait(69));
...
(lib.Scene_1__000 = function(mode,startPosition,loop) {
	...
	this.text.parent = this;
	this.text.setTransform(189.05,266.25);
	this.text.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,4);
	this.text._off = true;
...
(lib.Scene_1_pic2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-102,302.9);
	this.instance._off = true;

	this.instance_1 = new lib.Tween9("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(402,302.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},192).to({state:[{t:this.instance_1}]},192).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(192).to({_off:false},0).to({_off:true,x:402},192).wait(1));
...
(lib.Scene_1_pic = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(445,302.75);

	this.instance_1 = new lib.Tween7("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-145,302.75);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},191).wait(2));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,x:-145},191).wait(2));
...
// stage content:
(lib._300x600__ecopark0123_EN = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.pic.setTransform(445,302.8,1,1,0,0,0,445,302.8);
	this.pic.depth = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.pic).wait(191).to({_off:true},2).wait(192));
...
p.nominalBounds = new cjs.Rectangle(-440,300,1330,300.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"_02.jpg?1548257214908", id:"_02"},
		{src:"_03.jpg?1548257214908", id:"_03"},
		{src:"Logo_CEE_GoldWhite.png?1548257214908", id:"Logo_CEE_GoldWhite"}
	],
	preloads: []
};
